...
function SPLTokenMintFungibleOverviewRows() {
...
function SPLTokenMintFungibleOverview() {
  return (
    <ExplorerCard loading={<TableSkeleton />} error={null}>
      <ExplorerGrid>
        <SPLTokenMintFungibleOverviewRows />
      </ExplorerGrid>
    </ExplorerCard>
  );
}

export default SPLTokenMintFungibleOverview;
